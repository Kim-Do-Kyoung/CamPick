...
public class AddrDao {
	...
	public boolean insertDB(AddrDto addrbook) {
		...
		String sql ="insert into addrbook(ab_id,ab_name,ab_email,ab_birth,ab_tel,ab_comdept,ab_memo) values(addr_seq.nextval,?,?,?,?,?,?)";
	...
	public ArrayList<AddrDto> getDBList(){
		connect();
		ArrayList<AddrDto> datas = new ArrayList<>();
