<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" errorPage="addrbook/addrbook_error.jsp" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<!-- 		[<a href="addrbook_list.jsp">주소록 목록으로</a>]<p> -->
		...
		<form name=form1 method="post" action=/AddrBook/insert.do>
			<table border=1>
				<tr>
					<th>이 름</th>
				...
				<tr>
					<th>전화번호</th>
					<td><input type="tel" name="ab_tel" maxlength="20"></td>
				</tr>
				<tr>
					<th>생 일</th>
